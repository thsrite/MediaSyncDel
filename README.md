...
## 1.emby安装[ScripterX插件](https://github.com/AnthonyMusgrove/Emby-ScripterX) [3.0.5.5插件防止防自动升级版本下载](https://github.com/thsrite/emby_sync_del_nt/issues/6#issuecomment-1493281729)
...
## 4.注意事项及问题排查
#### （0）建议emby使用4.8.0.21及以下版本，ScripterX4.0.0.8在emby4.8.0.21以上版本疑似失效。[4.8.0.21以上版本可用ScripterX3.0.5.5版本，防止插件自动升级](https://github.com/thsrite/emby_sync_del_nt/issues/6#issuecomment-1493281729)
